            ...
            <div data-flex={'dir:' + dir} className="message-list-item">
                <div data-flex={'dir:' + dir} data-flex-box='0' className='message-container'>
                    <div data-flex-box='0' data-flex='main:top cross:top' className='avatar-container'>
                        <Avatar
                            src={avatar ? avatar : this.avatarCreate(sex)}
                            size={39}
                            userName={userName}
                            mode={dir}
                        />
                    ...
                    <div style={{
                        ...
                        <div className='message'>
                            ...
                            <div className={dir === 'left' ? 'triangle-left-outer' : 'triangle-right-outer'}/>
                            <div className={dir === 'left' ? 'triangle-left-inner' : 'triangle-right-inner'}/>
                        </div>
                    </div>
                </div>
            </div>
